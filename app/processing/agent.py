...
functions = [
    ...
    },
    {
        ...
        "description": "if in the current statement of human1, he/she is  greeting the other person ",
        "parameters": {
            "type": "object",
            "properties": {
                "question": {
...
def get_function(nickname, avatar, user_query, chat_history, current_summary):
    ...
    messages = [{"role": "user",
                 "content": f"behave like  a highly skilled AI trained in language comprehension and understanding the contexts. Read the following conversation between  human1  as {nickname}: and human2 as {avatar}: with their chat history as {chat_history} and the current  statement of  {nickname} is  {user_query}"}]
